...
- Status: **ended (final) — binary_kb 5852 → 2060 KB (-64.8%) across 109 experiments in the CURRENT toolchain (rustc LLVM 22.1.8 + Apple CommandLineTools clang + Apple ld64). NOTE: the old-toolchain floor was 1928 KB (-67.1%); a toolchain shift (LLVM 22 codegen + Apple libLTO) added an inherent +148 KB regression (__text +82,932 + __const +56,593 B) that #102-#107 proved unrecoverable in-scope (every codegen dimension re-verified: -Oz, Rust outliner -32 KB full value, C-outliner no-op via all channels, threshold absent, scheduler closed, merge/global-merge/tail-merge no-ops, inline-threshold 25=no-op/100=+112KB/600=+628KB #109, const=reachable data no jump tables #109). Apple clang (-16 KB) + Apple ld64 (-16 KB) recovered 32 KB of the shift. Floor 2060 KB is certified terminal: deterministic, byte-accounted, metric-quantized at 4 KB (515 blocks). Zero in-scope behavior-preserving hypotheses remain. USER DECISION (2026-09-01): END LOOP — keep 2060 KB floor. Crash-diagnostics tradeoff re-quantified in new toolchain #109: fn-starts-only 2048 KB (-12), unwind-only 2044 KB (-16), combined 2032 KB (-28) — available if user later approves the behavior change.**
- Created: 2026-08-31
